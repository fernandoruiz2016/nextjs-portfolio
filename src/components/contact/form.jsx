...
export default function Form() {
    ...
    const sendEmail = (params) => {
        ...
        emailjs
            .send(process.env.NEXT_PUBLIC_SERVICE_ID, process.env.NEXT_PUBLIC_TEMPLATE_ID, params,{
                ...
                limitRate: {
                    throttle: 10000, //you cannot send more than one email per 5 seconds
                }
            })
            .then(
                () => {
    ...
    return (
        ...
        >
            ...
            <input value="Cast your message!" className='px-10 py-4 rounded-md shadow-lg bg-background border border-accent/30 border-solid hover:shadow-glass-sm backdrop-blur-sm text-foreground focus:outline-none focus:ring-accent/50 cursor-pointer capitalize' type="submit" />
        </form>
        </>
